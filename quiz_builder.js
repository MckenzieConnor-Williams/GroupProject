(function () {
    ...
    const sampleQuestions = [
        ...
        {
            question: "Which component of the CPU is responsible for performing arithmetic calculations?",
            options: ["Control Unit", "Registers", "Cache", "ALU"],
            correctIndex: 3
        },
        {
        ...
        {
            question: "Which type of network covers a large geographical area such as a country?",
            options: ["LAN", "PAN", "WAN", "MAN"],
            correctIndex: 2
        },
        {
            question: "Which unit is used to measure the speed of a CPU?",
            options: ["Hertz", "Pixels", "Bytes", "Watts"],
            correctIndex: 0
        },
        {
            question: "Which programming language is commonly used for creating web page structure?",
            options: ["Python", "HTML", "C++", "Java"],
            correctIndex: 1
        },
        {
            question: "Which component temporarily stores frequently used data for quick access by the CPU?",
            options: ["Hard Drive", "RAM", "Cache", "GPU"],
            correctIndex: 2
        },
        {
        ...
        {
            question: "Which topology connects every device to every other device in the network?",
            options: ["Bus", "Star", "Ring", "Mesh"],
            correctIndex: 3
        },
        {
            question: "Which of the following is an example of an operating system?",
            options: ["Linux", "Photoshop", "Chrome", "Excel"],
            correctIndex: 0
        },
        {
            question: "Which protocol is used to send emails across the internet?",
            options: ["HTTP", "FTP", "SMTP", "TCP"],
            correctIndex: 2
        },
        {
            question: "Which data structure uses the First-In, First-Out principle?",
            options: ["Stack", "Queue", "Tree", "Array"],
            correctIndex: 1
        },
        {
            question: "What is the smallest unit of data in a computer?",
            options: ["Byte", "Nibble", "Word", "Bit"],
            correctIndex: 3
        },
        {
        ...
        {
            question: "Which device connects different networks together and directs traffic between them?",
        ...
        },
        {
            ...
            options: ["HTML", "C", "PHP", "Python"],
            correctIndex: 3
        },
        {
            question: "Which storage unit equals 1024 bytes?",
            options: ["Megabyte", "Kilobyte", "Gigabyte", "Terabyte"],
            correctIndex: 1
        },
        {
            question: "Which type of malware disguises itself as legitimate software?",
            options: ["Trojan Horse", "Virus", "Worm", "Spyware"],
            correctIndex: 0
        },
        {
            question: "Which HTML tag is used to create the largest heading?",
            options: ["<h4>", "<h2>", "<h1>", "<head>"],
            correctIndex: 2
        },
        {
            question: "Which programming concept allows code to be reused by creating new classes from existing ones?",
            options: ["Encapsulation", "Inheritance", "Iteration", "Compilation"],
            correctIndex: 1
        },
        {
            question: "Which network device broadcasts data to all connected devices without filtering?",
